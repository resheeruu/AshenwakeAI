...
function classifyHost(totalMemMB, freeMemMB, rssMB, heapMB, diskUsedPct) {
...
function generateProfileRecommendations(classification, totalMemMB, freeMemMB, rssMB, heapMB, diskUsedPct, dataDirMB) {
  const recs = [];

...
__export(policy_exports, {
  ASHENAI_PERSONALITY: () => ASHENAI_PERSONALITY,
  ASHENAI_SECURITY_POLICY: () => ASHENAI_SECURITY_POLICY,
  ASHENAI_SYSTEM_PROMPT: () => ASHENAI_SYSTEM_PROMPT
});
module.exports = __toCommonJS(policy_exports);
const ASHENAI_SECURITY_POLICY = `
IDENTITY

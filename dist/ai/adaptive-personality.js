...
var adaptive_personality_exports = {};
__export(adaptive_personality_exports, {
  buildAdaptivePersonality: () => buildAdaptivePersonality
});
module.exports = __toCommonJS(adaptive_personality_exports);
function buildAdaptivePersonality(profile) {
  if (!profile) {
    return `

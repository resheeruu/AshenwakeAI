...
export const ALL_SETTINGS: SettingDescriptor[] = [
  ...
  {
    id: "social.animeActions",
    label: "Anime Actions",
    description: "Enable the 'ash <action>' anime action mini-game",
    type: "boolean",
    category: "social",
    path: "social.animeActions",
    defaultValue: true,
  },
  {
    id: "social.afkAutoClear",
    label: "AFK Auto-Clear",
    description: "Automatically clear a user's AFK when they send a normal message (default on)",
    type: "boolean",
    category: "social",
    path: "social.afkAutoClear",
    defaultValue: true,
  },
  {

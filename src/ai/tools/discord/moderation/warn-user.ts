...
import { addWarning } from "../../../../discord/warnings";
import { canModerate, canTarget } from "../../../../discord/moderation";
import { logger } from "../../../../logger";

/* ================================================================
 * warn_user — Issue a warning to a guild member.
 *
 * MEDIUM risk. Confirmation required. Moderator+ role.
 * ================================================================ */

export function createWarnUserTool(getClient: () => Client | null): ToolDefinition {
  return {
    name: "warn_user",
    ...
    execute: async (context: ToolContext): Promise<ToolResult> => {
      ...
      (plan as any).toolName = "warn_user";
...
/* ================================================================
 * EXECUTE CONFIRMED PLAN — warn_user
 * ================================================================ */

export async function executeWarnUserPlan(
  plan: ActionPlan,
  ...
  // Execute warning
  const warning = addWarning(plan.guildId, userId, plan.requesterId, reason);

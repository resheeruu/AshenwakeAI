 ...
 *
 * Custom emoji IDs are automatically provisioned at startup via
 * emoji-provisioner.ts. Falls back to env vars or emoji-manifest.json
 * if auto-provisioning is unavailable.
 * ================================================================ */
